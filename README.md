...
###实体类生成插件 GsonFormat
</br>date:2016年11月19日21:36:58
</br>from:https://my.oschina.net/kooeasy/blog/479773
</br>使用：在实体类类名上选中，然后选择顶部菜单的 Code->generate 然后在弹出的输入框里面输入json，然后会自动生成相关的实体类 并包含相关的构造方法
